...
def max_pool_2x2(layer):
    return tf.nn.max_pool(value=layer, ksize=[1, 3, 3, 1], strides=[1, 2, 2, 1], padding='SAME')
...
def new_conv_layer(layer, num_input_channels, filter_size, num_filters, stride, use_pooling, pad=0,  poolpad=0):
...
def train(img_dir, model_dir, img_size=227, colour_channels=3, batch_size=128, training_epochs=10):
